 ...
 * Original file: /npm/universalviewer@4.0.25/dist/umd/UV.js
 *
      ...
      r = {
        6783: (e, t, n) => {
          ...
          var r,
            o = (function () {
              function e() {}
              return (
                (e.waitFor = function (t, n, r, o, i, a) {
                  o || (o = 200),
                    i || (i = 100),
                    a || (a = 0),
                    (a += 1) > i
                ...
                (e.fitRect = function (e, t, n, r) {
                  ...
                  return (
                    t / e < r / n
                      ? ((i = e * (o = n / e)), (a = t * o))
                      : ((i = e * (o = r / t)), (a = t * o)),
                    new f(Math.floor(i), Math.floor(a))
                  );
                }),
              ...
              return (
                ...
                (e.getItems = function (e) {
                  ...
                  switch (e) {
                    case r.MEMORY:
                      for (
                        var n = Object.keys(this._memoryStorage), o = 0;
                        o < n.length;
                        o++
                      )
                        (a = this.get(n[o], r.MEMORY)) && t.push(a);
                      break;
                    case r.SESSION:
                      for (o = 0; o < sessionStorage.length; o++)
                        (i = sessionStorage.key(o)) &&
                          (a = this.get(i, r.SESSION)) &&
                          t.push(a);
                      break;
                    case r.LOCAL:
                      for (o = 0; o < localStorage.length; o++) {
                        var i, a;
                        (i = localStorage.key(o)) &&
                          (a = this.get(i, r.LOCAL)) &&
                          t.push(a);
                      }
                  }
                  return t;
                ...
                (e.set = function (e, t, n, o) {
                  ...
                  var i = 1e3 * n,
                    a = new v();
                  switch (
                    ((a.value = t), (a.expiresAt = new Date().getTime() + i), o)
                  ) {
                    case r.MEMORY:
              ...
              return (
                (e.ellipsis = function (e, t) {
                  ...
                  var n = e.substr(0, t),
                    r = n.lastIndexOf(" ");
                  return (
                    -1 != r && (n = n.substr(0, Math.min(n.length, r))),
                    n + "&hellip;"
                  );
                }),
              ...
              return (
                (e.getHashParameter = function (e, t) {
                  return (
                    t || (t = window.document),
                    t && t.location
                      ? this.getHashParameterFromString(e, t.location.hash)
                      : null
                  );
                }),
                ...
                (e.setHashParameter = function (e, t, n) {
                  if ((n || (n = window.document), n && n.location)) {
                    var r =
                        "#?" +
                        this.updateURIKeyValuePair(
                          n.location.hash.replace("#?", ""),
                          e,
                          t,
                        ),
                      o = n.URL;
                    -1 != o.indexOf("#") && (o = o.substr(0, o.indexOf("#"))),
                      n.location.replace(o + r);
                  }
                }),
                ...
                (e.setQuerystringParameter = function (e, t, n) {
                  if ((n || (n = window.document), n && n.location)) {
                    var r = this.updateURIKeyValuePair(
                      n.location.hash.replace("#?", ""),
                      e,
                      t,
                    );
        ...
        9755: function (e, t) {
          ...
          !(function (t, n) {
            ...
            var C = (function (e) {
              ...
              try {
                D.apply((N = j.call(w.childNodes)), w.childNodes),
              ...
              (se.attr = function (e, t) {
                ...
                var o = r.attrHandle[t.toLowerCase()],
                  i =
                    o && k.call(r.attrHandle, t.toLowerCase())
                      ? o(e, t, !g)
                      : void 0;
                return void 0 !== i
                  ? i
                ...
                return (
                  ...
                  ue(function (i, a, s, c) {
                    var u,
                      ...
                      m = n ? (o || (i ? e : h || r) ? [] : a) : v;
                    if ((n && n(v, m, s, c), r))
                      for (u = Ee(m, p), r(u, [], s, c), l = u.length; l--; )
                        (f = u[l]) && (m[p[l]] = !(v[p[l]] = f));
                    if (i) {
                      if (o || e) {
                        if (o) {
                      ...
                      (m = Ee(m === a ? m.splice(h, m.length) : m)),
                        o ? o(null, a, m, c) : D.apply(a, m);
                  })
                );
              }
              function Te(e) {
                ...
                (a = se.tokenize =
                  function (e, t) {
                    ...
                    for (s = e, c = [], u = r.preFilter; s; ) {
                      ...
                      (o = z.exec(s)) &&
                        ((n = o.shift()),
                        i.push({ value: n, type: o[0].replace(G, " ") }),
                        (s = s.slice(n.length))),
                      r.filter))
                        !(o = Y[a].exec(s)) ||
                          (u[a] && !(o = u[a](o))) ||
                ...
                (c = se.select =
                  function (e, t, n, o) {
                    ...
                    if (((n = n || []), 1 === p.length)) {
                      ...
                      for (
                        i = Y.needsContext.test(e) ? 0 : c.length;
                ...
                function (e, t) {
                  T.fn[e] = function (n, r) {
                    ...
                    return (
                      ...
                      this.length > 1 &&
                        (H[e] || T.uniqueSort(o), R.test(e) && o.reverse()),
                      this.pushStack(o)
                    );
                  };
                },
                    ...
                    o = {
                      ...
                      then: function (e, n, o) {
                        ...
                        return T.Deferred(function (r) {
                          t[0][3].add(a(0, r, m(o) ? o : M, r.notifyWith)),
                            t[1][3].add(a(0, r, m(e) ? e : M)),
                            t[2][3].add(a(0, r, m(n) ? n : U));
                        }).promise();
                      },
                      promise: function (e) {
            ...
            (T.event = {
                  ...
                  for (u = (t = (t || "").match(F) || [""]).length; u--; )
                    if (
                      ...
                      a &&
                        ...
                        delete c[p]);
                    } else for (p in c) T.event.remove(e, p + t[u], n, r, !0);
              ...
              dispatch: function (e) {
                var t,
                  ...
                  c = T.event.fix(e),
                  u =
                    (Q.get(this, "events") || Object.create(null))[c.type] ||
                    [],
                ...
                if (
                  ...
                  return (
                    l.postDispatch && l.postDispatch.call(this, c), c.result
                  );
                }
              },
            ...
            function Fe(e, t) {
              ...
              if (1 === t.nodeType) {
                ...
                Z.hasData(e) &&
                  ((i = Z.access(e)), (a = T.extend({}, i)), Z.set(t, a));
              }
            }
            function Me(e, t) {
              var n = t.nodeName.toLowerCase();
            ...
            function Ue(e, t, n, r) {
              ...
              if (
                g ||
                (d > 1 && "string" == typeof h && !v.checkClone && De.test(h))
              )
              ...
              if (
                ...
                for (s = (a = T.map(xe(o, "script"), He)).length; f < d; f++)
                  (u = o),
                    f !== p &&
                      ((u = T.clone(u, !0, !0)),
                    ...
                    (u = a[f]),
                      ye.test(u.type || "") &&
                        ...
                        (u.src && "module" !== (u.type || "").toLowerCase()
                          ...
                          : w(u.textContent.replace(je, ""), u, l));
              }
              return e;
            }
            function qe(e, t, n) {
            ...
            function rt(e, t, n, r, o, i) {
              ...
              for (; a < 4; a += 2)
                "margin" === n && (c += T.css(e, n + ie[a], !0, o)),
                  r
                    ? ("content" === n &&
                        (c -= T.css(e, "padding" + ie[a], !0, o)),
                      "margin" !== n &&
                        (c -= T.css(e, "border" + ie[a] + "Width", !0, o)))
                    : ((c += T.css(e, "padding" + ie[a], !0, o)),
                      "padding" !== n
                        ? (c += T.css(e, "border" + ie[a] + "Width", !0, o))
                ...
                ajax: function (e, t) {
                  ...
                  function A(e, t, a, c) {
                    ...
                    u ||
                      ...
                      (S.statusText = (t || E) + ""),
                      f
                        ? v.resolveWith(h, [d, E, S])
                        : v.rejectWith(h, [S, E, b]),
                      S.statusCode(y),
                      (y = void 0),
                      l &&
            ...
            T.ajaxSetup({
              ...
              T.ajaxPrefilter("json jsonp", function (e, t, n) {
                ...
                if (s || "jsonp" === e.dataTypes[0])
                  return (
                    ...
                    s
                      ? (e[s] = e[s].replace(Kt, "$1" + o))
                      : !1 !== e.jsonp &&
                        (e.url +=
                          (_t.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
                    ...
                    n.always(function () {
                      void 0 === i ? T(r).removeProp(o) : (r[o] = i),
                        e[o] &&
                          ((e.jsonpCallback = t.jsonpCallback), Xt.push(o)),
                        a && m(i) && i(a[0]),
                        (a = i = void 0);
                    }),
                    "script"
              ...
              T.each(["top", "left"], function (e, t) {
                T.cssHooks[t] = Ve(v.pixelPosition, function (e, n) {
                  if (n)
                    return (
                      (n = $e(e, t)), Ge.test(n) ? T(e).position()[t] + "px" : n
                    );
                });
              }),
              ...
              if (C) {
                ...
                (A = S),
                  _ || O || k
                    ...
                    : h(S) || c(S)
                      ? ((A = E),
                        c(E) ? (A = m(E)) : (p(E) && !d(E)) || (A = s(S)))
                      : (C = !1);
              }
              C && (w.set(S, A), b(A, S, y, x, w), w.delete(S)), r(e, n, A);
            }
          };
        },
        5976: (e, t, n) => {
            ...
            return (
              ...
              (e.prototype.fire = function (e) {
                ...
                for (
                  ...
                  o[i].cb.apply(o[i].ctx, r);
              }),
              (e.prototype.showSpinner = function () {
                var e;
                null === (e = this._el.parentElement) ||
                  void 0 === e ||
              ...
              (e.prototype.dispose = function () {
                ...
                (this._el.innerHTML = ""),
                  (this._el.className = ""),
                  null === (e = this.adapter) || void 0 === e || e.dispose();
              }),
              e
            );
          })();
              ...
              ((function () {
                ...
                (e.clear = function (e) {
                  ...
                  (e.clearExpired = function (e) {
                    ...
                    for (var t = this.getItems(e), n = 0; n < t.length; n++) {
                      var r = t[n];
                      this._isExpired(r) && this.remove(r.key);
                    }
                  }),
                  (e.get = function (e, t) {
                    void 0 === t && (t = l.MEMORY);
                  ...
                  (e.getItems = function (e) {
                    ...
                    switch (e) {
                      case l.MEMORY:
                        for (
                          var n = Object.keys(this._memoryStorage), r = 0;
                          r < n.length;
                          r++
                        )
                          (i = this.get(n[r], l.MEMORY)) && t.push(i);
                        break;
                      case l.SESSION:
                        for (r = 0; r < sessionStorage.length; r++)
                          (o = sessionStorage.key(r)) &&
                            (i = this.get(o, l.SESSION)) &&
                            t.push(i);
                        break;
                      case l.LOCAL:
                        for (r = 0; r < localStorage.length; r++) {
                          var o, i;
                          (o = localStorage.key(r)) &&
                            (i = this.get(o, l.LOCAL)) &&
                            t.push(i);
                        }
                    }
                    return t;
                  ...
                  (e.set = function (e, t, n, r) {
                    void 0 === r && (r = l.MEMORY);
                    var o = 1e3 * n,
                      i = new h();
                    switch (
                      ((i.value = t),
                      (i.expiresAt = new Date().getTime() + o),
                      r)
                    ) {
                      case l.MEMORY:
                        this._memoryStorage[e] = JSON.stringify(i);
                        break;
                      case l.SESSION:
        ...
        6006: (e, t, n) => {
          ...
          var r = (function () {
            ...
            return (
              ...
              (e.CREATE = "create"),
              (e.CURRENT_TIME_CHANGE = "currentTimeChanged"),
              (e.RANGE_TIME_CHANGE = "rangeTimeChanged"),
              ...
              (e.LEFTPANEL_COLLAPSE_FULL_FINISH =
                "leftPanelCollapseFullFinish"),
              ...
              (e.PAGE_UP = "pageUp"),
              (e.PAUSE = "pause"),
              (e.PINPOINT_ANNOTATION_CLICKED = "pinpointAnnotationClicked"),
              (e.PLUS = "plus"),
              (e.PREV = "prev"),
              ...
              (e.RIGHTPANEL_COLLAPSE_FULL_FINISH =
                "rightPanelCollapseFullFinish"),
              (e.RIGHTPANEL_COLLAPSE_FULL_START =
              ...
              (e.MESSAGE_DISPLAYED = "messageDisplayed"),
          ...
          (t.whiteList = {
            ...
            (t.safeAttrValue = function (e, t, n, r) {
              if (((n = S(n)), "href" === t || "src" === t)) {
                ...
                if (
                  ((m.lastIndex = 0),
                  m.test(n) && ((g.lastIndex = 0), g.test(n)))
                )
                  return "";
            ...
            (t.clearNonPrintableCharacter = E),
                ...
                onIgnoreTag: function (a, s, c) {
                  if (
                    ...
                    if (c.isClosing) {
                      ...
                      return (
                        r.push([!1 !== o ? o : c.position, l]), (o = !1), u
                      );
                    }
        ...
        3268: (e, t, n) => {
          ...
          function o(e) {
            ...
            return (
              "/" === (n = r.trim(n).toLowerCase()).slice(0, 1) &&
                (n = n.slice(1)),
          ...
          (t.parseTag = function (e, t, n) {
            ...
            (t.parseAttr = function (e, t) {
              ...
              function f(e, n) {
                if (
                  !(
                    (e = (e = r.trim(e)).replace(a, "").toLowerCase()).length <
                    1
                  )
                ) {
                  var i = t(e, n || "");
              ...
              return (
                n < e.length &&
                  (!1 === i ? f(e.slice(n)) : f(i, u(r.trim(e.slice(n))))),
                r.trim(o.join(" "))
              );
            });
        },
              ...
              function (e, t, o, a, g) {
                ...
                if (m.isWhite) {
                  ...
                  var y = (function (e) {
                      ...
                      var n =
                        "/" === (e = c.trim(e.slice(t + 1, -1)))[e.length - 1];
                      return (
                        n && (e = c.trim(e.slice(0, -1))),
                        { html: e, closing: n }
                      );
                    })(a),
                    b = n[o],
    ...
    (i.m = r),
      ...
      (i.u = (e) =>
        ...
        "." +
        {
          ...
          250: "bd53b17bdda7a6841a32",
          254: "018af2cb451dd6bd4bfe",
          258: "466bfa6f7f2a5b8db234",
          ...
          2063: "c094c89c579da22bd3cd",
          2101: "94cef40080d5a0c9a8f1",
          2136: "0aec74590f2c32af6e44",
          2149: "9b0838dd704d7cefae1b",
          2185: "34b4770909a62ebe892e",
          ...
          6305: "0c443d34834424452b37",
          6362: "4da6462d04c297e049d3",
          6426: "6748e32cd38c9e5645b3",
          6682: "bd472cc5c41a863f05f7",
          6890: "c2f8ac96c59aca4e3f41",
          6906: "8833e07553e3366af475",
          ...
          7484: "468f27df41f99efd4b79",
          7493: "94542db6446f5d16046e",
          7536: "ac38571f332d1103881e",
          7548: "27540729628fd3a82ee2",
          ...
          8863: "c56e62097ef300b4ee08",
          8889: "cfa163bda182453e2ef1",
          8893: "085f453eeef590de6bac",
          8924: "157f5f028aea74508be7",
          ...
          9758: "96d6531220042113b4a3",
          9783: "6e19c50125a2bedef431",
          9851: "dbd91ba5446b75c54c09",
          9981: "ed60c9bfdff4fe96949b",
        }[e] +
        ".js"),
      (i.g = (function () {
      ...
      (i.l = (e, t, r, o) => {
        if (n[e]) n[e].push(t);
          ...
          if (void 0 !== r)
            for (
              ...
              if (
                ...
                l.getAttribute("data-webpack") == "UV:" + r
              ) {
                a = l;
                break;
              }
          ...
          a ||
            ...
            a.setAttribute("data-webpack", "UV:" + r),
            (a.src = e)),
            (n[e] = [t]);
          var f = (t, r) => {
    ...
    return (
      (() => {
        ...
        function l(e) {
          if (Array.isArray(e))
            return e.reduce(
              function (e, t) {
                ...
                return (
                  o &&
                    (e.selector || (e.selector = o),
                    (n = e.selectors).push.apply(n, i)),
                  e
                );
              },
              { selector: null, selectors: [] },
            );
          if (!e) return { selector: null, selectors: [] };
          if ("string" == typeof e) {
            var t = e.split("#"),
              n = (t[0], t[1]);
            return n
              ? l({ type: "FragmentSelector", value: n })
              : { selector: null, selectors: [] };
          }
          if ("PointSelector" === e.type && (e.t || 0 === e.t))
            return {
              selector: (o = { type: "TemporalSelector", startTime: e.t }),
              selectors: [o],
            };
          ...
          return { selector: null, selectors: [] };
        }
        var f = function () {
          return (
            (f =
        ...
        function d(e, t) {
          ...
          if ("string" == typeof e) {
            ...
            return (s = n[1])
              ? d({
                  ...
                  selector: { type: "FragmentSelector", value: s },
                })
              : {
                  type: "SpecificResource",
                  source: {
          ...
          if ("SpecificResource" === e.type) {
            "Canvas" === e.source.type &&
              e.source.partOf &&
              "string" == typeof e.source.partOf &&
              (e.source.partOf = [{ id: e.source.partOf, type: "Manifest" }]);
            var o = e.selector
                ? l(e.selector)
                : { selector: null, selectors: [] },
              i = o.selector,
          ...
          if (e.id) {
            "Canvas" === e.type &&
              e.partOf &&
              "string" == typeof e.partOf &&
              (e.partOf = [{ id: e.partOf, type: "Manifest" }]);
            var s,
              c = e.id.split("#");
            return (
              (r = c[0]),
        ...
        function h(e, t) {
          if ("{" === (e = e.trim())[0])
            return t ? Promise.resolve(JSON.parse(e)) : JSON.parse(e);
          ...
          return h(
            ...
            (r =
              "undefined" == typeof atob
                ? Buffer.from(n, "base64").toString("utf-8")
                : atob(n)),
            decodeURIComponent(r).trim()),
            t,
          );
          var n, r;
        }
        function g(e) {
          if (!e) return null;
          if ("string" == typeof e && e.startsWith("http"))
            return { type: "remote-content-state", id: e };
          try {
            return (function (e) {
              if (!e) throw new Error("Content state is empty");
              Array.isArray(e) || (e = [e]);
              for (
                var t = "vault://virtual-annotation/" + new Date().getTime(),
                  n = ["contentState"],
                  r = [],
                  o = 0,
                  i = e;
          ...
          w = (function (e) {
            ...
            return (
              ...
              (t.prototype.set = function (e, t) {
                this.readonly ||
                  (t
                    ? r.nn.setHashParameter(e, t, document)
                    : null !== r.nn.getHashParameter(e) &&
                      r.nn.setHashParameter(e, "", document));
              }),
              (t.prototype.getInitialData = function (e) {
                ...
                if (a) {
                  ...
                  if ("remote-content-state" === f.type) c = f.id;
                    ...
                    var d = f.target[0];
                    if (
                      "SpecificResource" === d.type &&
                      "Canvas" === d.source.type
                    ) {
                      var p = (d.source.partOf || []).find(function (e) {
                        return "Manifest" === e.type;
                      });
                      d.selector &&
                        "BoxSelector" === d.selector.type &&
                        ((u = d.source.id),
                        (l =
                          d.selector.x +
                          "," +
                ...
                return x(
                  {
                    iiifManifestId:
                      this.get("iiifManifestId") || this.get("manifest"),
              ...
              (t.prototype.bindTo = function (e) {
                ...
                (e.adapter = this),
                  ...
                  e.on(
                    o.p.RANGE_CHANGE,
                    function (e) {
                      var n = e && "string" != typeof e ? e.id : e;
                      t.set("rid", n);
                    },
                    !1,
                  ),
        ...
        !(function (e) {
          (e.IIIFLEGACY = "manifest"),
            (e.IIIF = "iiifManifestId"),
            (e.YOUTUBE = "youTubeVideoId"),
            (e.UNKNOWN = "unknown");
        })(y || (y = {}));
        var T =
            (((m = {})[y.IIIF] = function () {
          ...
          A = (function (e) {
            function t(t) {
              ...
              return (
                (n.options = t),
                (n._contentType = y.UNKNOWN),
                (n._externalEventListeners = []),
                n._assignContentHandler(n.options.data),
                n
              );
            }
            return (
              ...
              (t.prototype.on = function (e, t, n) {
                this._externalEventListeners.push({ name: e, cb: t, ctx: n });
              }),
                    ...
                    return (function (e, t) {
                      ...
                      switch (i.label) {
                        case 0:
                          return (
                            e[y.IIIFLEGACY]
                              ? ((e.iiifManifestId = e[y.IIIFLEGACY]),
                                delete e[y.IIIFLEGACY],
                                (n = y.IIIF))
                              : (n = e[y.IIIF]
                                  ? y.IIIF
                                  : e[y.YOUTUBE]
                                    ...
                                    : this._contentType
                                      ? this._contentType
                                      : y.UNKNOWN),
                            (r = this._contentType !== n),
                            n !== y.UNKNOWN
                              ? [3, 1]
                              : (console.error("Unknown content type"), [3, 3])
                          );
                        case 1:
                          return r
                            ? ((this._contentType = n),
                              null === (t = this._assignedContentHandler) ||
                                void 0 === t ||
                                t.dispose(),
                              [4, T[n]()])
                            : [3, 3];
                        case 2:
                          (o = i.sent()),
                            this.showSpinner(),
                            (this._assignedContentHandler = new o.default(
                              { target: this._el, data: e },
                              this.adapter,
              ...
              (t.prototype.set = function (e, t) {
                var n = this;
                this._assignContentHandler(e).then(function (r) {
                  r ? n.showSpinner() : n._assignedContentHandler.set(e, t);
                });
              }),
              (t.prototype.exitFullScreen = function () {
                var e;
                null === (e = this._assignedContentHandler) ||
                  void 0 === e ||
                  e.exitFullScreen();
              }),
          ...
          O = function (e, t) {
            ...
            var c = function () {
              n &&
                (r && !o
                  ...
                  : ((a.style.width = i.offsetWidth + "px"),
                    (a.style.height = i.offsetHeight + "px")),
                n.resize());
            };
            function u(e) {
              (("webkitfullscreenchange" === e.type &&
                !document.webkitIsFullScreen) ||
                ("fullscreenchange" === e.type &&
                  !document.fullscreenElement) ||
                ("mozfullscreenchange" === e.type && !document.mozFullScreen) ||
                ("MSFullscreenChange" === e.type &&
            ...
            return (
              ...
              n.on(
                C.z.TOGGLE_FULLSCREEN,
                function (e) {
                  if (
                    ((r = e.isFullScreen),
                    (o = e.overrideFullScreen),
                    !e.overrideFullScreen)
                  )
                    if (r) {
                      var t = (i = a).webkitRequestFullscreen
                      ...
                      var n = document.webkitExitFullscreen
              ...
              document.addEventListener("fullscreenchange", u, !1),
              document.addEventListener("webkitfullscreenchange", u, !1),
              document.addEventListener("mozfullscreenchange", u, !1),
              document.addEventListener("MSFullscreenChange", u, !1),
              n
            );
          };
      })(),
