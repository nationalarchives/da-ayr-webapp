...
def test_browse_transferring_body_get(client: FlaskClient):
    """
...
def test_browse_transferring_body_with_no_results(client: FlaskClient):
    """
...
def test_browse_transferring_body_results_displayed(client: FlaskClient):
    """
    Given user logged in application
