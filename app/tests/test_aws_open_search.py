...
# Decorate your test functions to activate the mock services
...
def test_get_open_search_index_from_aws_params():
    ...
    from app.main.aws.open_search import get_open_search_index_from_aws_params
...
def test_generate_open_search_client_from_aws_params_with_moto(mock_open_search):
    # Set up your mock AWS parameters
    ssm_client = boto3.client("ssm")
    ssm_client.put_parameter(
        Name="ENVIRONMENT_NAME",
        Value="test_env",
    ...
    from app.main.aws.open_search import generate_open_search_client_from_aws_params
