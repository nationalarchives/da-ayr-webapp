...
def test_search_view_get(client: FlaskClient):
    """
...
def test_search_view_no_query(client: FlaskClient):
    """
    Given a user accessing the search page
...
def test_search_view_with_no_results(client: FlaskClient):
    """
...
def test_search_view_results_displayed(client: FlaskClient):
    """
