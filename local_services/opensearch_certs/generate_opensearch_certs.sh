...
openssl req -new -key opensearch-node1.key -out opensearch-node1.csr -subj "/C=GB/ST=England/L=London/O=Test/CN=opensearch-node1"
openssl req -new -key opensearch-node2.key -out opensearch-node2.csr -subj "/C=GB/ST=England/L=London/O=Test/CN=opensearch-node2"
