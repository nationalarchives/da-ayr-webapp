    ...
    with app.app_context():
        try:
            ...
            mime_types = {
                ...
                "wk1": {"application/vnd.lotus-1-2-3", "x-fmt/115"},
                ...
                "epub": {"application/epub+zip", "fmt/483"},
                "odt": {"application/vnd.oasis.opendocument.text", "fmt/136"},
                "xml": {"application/xml", "fmt/101"},
            }
